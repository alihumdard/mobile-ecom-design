...
const ProductSlider2 = () => {
  ...
  // Split products into groups of 2 for 2 rows per slide
  ...
  return (
    <div className="w-full">
      <div className="relative py-10 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-40 bg-[url('/images/bg-1.png')] bg-cover bg-center mt-10">
        {/* Top Bar */}
