...
const Official = () => {
  ...
  return (
    <div>
      <div>
        <h1 className="px-40 text-xl font-semibold pt-20 pb-10">
          Online Official Retailer
        </h1>

        <div className="grid grid-cols-6 px-[27%] bg-[#deeaf3] pt-14">
          <div className="flex flex-col items-center justify-center text-center cursor-pointer">
            ...
            />
            <p className="text-sm font-semibold text-white z-10s mb-2m absolute">
              Samsung
            </p>
          </div>
        ...
        <div className="flex flex-col items-center justify-center text-center bg-[#deeaf3] pb-10 mb-10 cursor-pointer">
          <img
            src="/images/official-2.svg"
            alt="Samsung"
            className="w-24 h-24 object-contain relative"
